...
class _$CategoriesModelImpl implements _CategoriesModel {
  const _$CategoriesModelImpl({final List<Genre>? genres}) : _genres = genres;
  ...
  @override
  String toString() {
    return 'CategoriesModel(genres: $genres)';
  }
...
abstract class _CategoriesModel implements CategoriesModel {
  const factory _CategoriesModel({final List<Genre>? genres}) =
