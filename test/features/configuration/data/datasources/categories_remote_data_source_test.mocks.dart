...
// in movie_colony/test/features/categories/data/datasources/categories_remote_data_source_test.dart.
...
import 'package:movie_colony/core/config.dart' as _i9;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockConfig extends _i1.Mock implements _i9.Config {
  MockConfig() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.Future<String> fetchToken(String? value) =>
      (super.noSuchMethod(Invocation.method(#fetchToken, [value]),
          returnValue: Future<String>.value('')) as _i6.Future<String>);
}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockConfig2 extends _i1.Mock implements _i9.Config {
  @override
  _i6.Future<String> fetchToken(String? value) =>
      (super.noSuchMethod(Invocation.method(#fetchToken, [value]),
          returnValue: Future<String>.value('')) as _i6.Future<String>);
